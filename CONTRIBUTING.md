# Contribute to Eslint Config CA Library
Contributions are welcome and much appreciated. Just follow these easy steps to contribute.

## Code Standard and Guideline
For consistency, we ask that you adhere to some basic code guidelines when contributing to Eslint Config CA Library. See the [Code Standard and Guideline][guidelines] for details.

## Our Development Process
To continue improving the library, the Eslint Config CA Library development team will work on the same GitHub repos as you. The `master branch` is used only for stable releases.
...
Complete your CLA here: <https://www.clahub.com/agreements/CAAPIM/eslint-config-ca>
...
## License
By contributing to Eslint Config CA Library, you agree that your contributions will be licensed under its [license][license-link].
 ...
 [cla]: https://www.clahub.com/agreements/CAAPIM/eslint-config-ca
